...
%Save data
save('idiadaData','centerlineX','centerlineY','centerlineZ','curvature','curvature2d','curvilinearAb','leftMarginX','leftMarginY','leftMarginZ','rightMarginX','rightMarginY','rightMarginZ','normalX','normalY','normalZ','roadWidth','tangentX','tangentY','tangentZ','SecondDerZ','FirstDerZ', 'Angle_banking');
